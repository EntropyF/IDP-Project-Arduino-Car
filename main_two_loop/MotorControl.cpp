...
void MotorControl::MotorSetup() {
  ...
  servo1.write(0); // Set the initial position to the center
}
...
// 90 degree rotation functions: leftR = 100 when SetMotors(-200,180); COM almost stay in same position
// Remember to do a Mcon.Reset() after another rotation
...
// 90 degree rotation functions: rightR = 110 when SetMotors(200,-180); COM almost stay in same position
